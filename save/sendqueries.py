from save.timestamp import EndOfGame
from save.checkplayer import CheckPlayer
...
def db_queries(player_name, character_name, game_time_string, end_result):
    ...
    add_player.insert_game(player_name, character_name, end_result, game_time_string)
