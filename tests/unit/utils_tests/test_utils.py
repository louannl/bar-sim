...
from tests.unit.game_engine.helper import dummy_character_request, dummy_character_request_win_stats
...
class RandomInsult(TestCase):
    ...
    def is_api_response200(self):
        ...
        self.assertTrue("<Response[200]>", insult)

    def is_str_returned_not_empty(self):
        insult = random_insult()
        self.assertTrue(str, insult)
        # an empty string would evaluate False
